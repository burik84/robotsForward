...
// Создание инструкций task' проверка работы)
gulp.task('mytask', function() {
    console.log('Привет, это Гальп)');
});
...
gulp.task('image',['imageall'],function () {
    return del.sync('dist/img/source'); /* удаление папки source в dist/img*/
});
